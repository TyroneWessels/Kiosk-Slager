...
local products = {
    { name = "Kip wrap", price = 6.50 },
    { name = "Vlees wrap", price = 7.00 },
    { name = "Kaas wrap", price = 5.50 },
    { name = "Groente wrap", price = 5.00 },
    { name = "Speciaal wrap", price = 7.50 },
}

local function gotostart()
    cart:clear()
    composer.removeScene( "wraps" )
...
local function addToCart(name, price, quantity)
    ...
    cart:addItem(name, price, "wraps", quantity)
...
function scene:create( event )
    ...
    -- Title
    local title = display.newText(sceneGroup, "Wraps", display.contentWidth * 0.5, 20, native.systemFont, 30)
    ...
    local fotoNames = {"Wrapkip", "Wrapvlees", "Wrapkaas", "Wrapgroente", "Wrapspeciaal"}

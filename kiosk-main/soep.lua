...
local products = {
    ...
    { name = "Champignonsoep", price = 4.50 },
    { name = "Uiensoep", price = 3.50 },
    { name = "Groentesoep", price = 4.00 },
    { name = "Erwtensoep", price = 4.00 },
}
...
local function addToCart(name, price, quantity)
    ...
    cart:addItem(name, price, "soep", quantity)
...
function scene:create( event )
    ...
    -- Title
    local title = display.newText(sceneGroup, "Soep", display.contentWidth * 0.5, 20, native.systemFont, 30)
    ...
    local fotoNames = {"Soeptomaten", "Soepchampignon", "Soepuien", "Soepgroente", "Soeperwten"}
